...
export function LinkTile({ title, description, url }: LinkTileProps) {
  return (
    <a
      ...
      className="group block p-8 bg-white border border-gray-100 rounded-lg hover:border-brand-blue-primary hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
