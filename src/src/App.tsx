            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8">
                <a
                  ...
                  className="text-brand-blue-primary hover:text-brand-blue-light transition-colors duration-200 hover:underline underline-offset-4 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-sm"
                >
                  SG2 Technologies →
                </a>
                <a
            ...
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-brand-neutral-grey">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-brand-blue-primary hover:underline underline-offset-2 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-sm"
                >
                  Sidiqi.ai
                </a>
                .
